...
class AuthorizeNetPayment
{
    ...
    public function setCreditCard($cardDetails)
    {
        ...
        $creditCard->setCardNumber($cardDetails["card-number_detail"]);
        $creditCard->setExpirationDate( $cardDetails["year_card"] . "-" . $cardDetails["month_card"]);
    ...
    public function chargeCreditCard($cardDetails)
    {
        ...
        $transactionRequestType = $this->setTransactionRequestType($paymentType, $_POST["amount11"]);
